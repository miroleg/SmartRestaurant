...
Убедитесь, что все работает с последней версией, размещенной на github :)  
При разработке учитывайте, что ваш API будет использоваться для разработки фронтэнда.
